...
class FFILanguage
	...
	fun compile_extern_method(block: AExternCodeBlock, m: AExternPropdef, ecc: CCompilationUnit, nmodule: AModule) is abstract
	fun compile_extern_class(block: AExternCodeBlock, m: AClassdef, ecc: CCompilationUnit, nmodule: AModule) is abstract
	fun get_ftype(block: AExternCodeBlock, m: AClassdef): ForeignType is abstract
	fun compile_callback(callback: NitniCallback, nmodule: AModule, mainmmodule: MModule, ecc: CCompilationUnit) is abstract

...
redef class MMethodDef
	...
	# Name of the implementation of this method
	fun impl_cname(mmodule: MModule): String do return "{mmodule.name}___{cname}___impl"

	# Name of the function to callback super of this method from C
	fun super_cname(mmodule: MModule): String do return "{mmodule.name}___{cname}___super"
end
...
redef class MType
	...
	# Hides extern types.
	fun cname_blind: String do abort

	# Representation of this type in mangled C
	#   Object -> Object
	#   Pointer -> Pointer
	fun mangled_cname: String do
		print class_name
		print self
		abort
	end

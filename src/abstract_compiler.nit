...
class MakefileToolchain
	...
	do
		...
		makefile.write("CC = ccache cc\nCXX = ccache c++\nCFLAGS = -g -O0 -Wno-unused-value -Wno-switch\nCINCL = {cc_includes}\nLDFLAGS ?= \nLDLIBS  ?= -lm -lgc {linker_options.join(" ")}\n\n")
...
abstract class AbstractCompilerVisitor
	...
	fun unbox_signature(m: MMethodDef, args: Array[RuntimeVariable]) is abstract
	...
	fun box(value: RuntimeVariable, mtype: MType): RuntimeVariable is abstract

	# Unbox extern classes to be used in extern code (legacy NI and FFI)
	fun unbox(value: RuntimeVariable, mtype: MType): RuntimeVariable is abstract

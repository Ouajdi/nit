...
extern class GLRenderbufferFormat
	...
	# 16 depth bits
	new depth_component16 `{ return GL_DEPTH_COMPONENT16; `}

	# 8 stencil bits
	new stencil_index8 `{ return GL_STENCIL_INDEX8; `}
end

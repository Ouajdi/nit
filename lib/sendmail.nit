...
# Can we fint the external program `sendmail`?
...
class Mail
	...
	# Receipients of the message
	var to = new Array[String]
	
	# Receipients of a carbon copy of the message
	var cc = new Array[String]

	# Receipients of a blind carbon copy of the message

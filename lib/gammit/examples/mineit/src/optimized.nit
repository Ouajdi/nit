...
redef class Sys
	fun left: Int do return 0
	fun right: Int do return 1
	fun top: Int do return 2
	fun bottom: Int do return 3
	fun front: Int do return 4
	fun back: Int do return 5
end
...
redef class Block
	...
	private fun add_faces_to(world: MineitWorld, display: GammitDisplay)
	do
		var side = 0

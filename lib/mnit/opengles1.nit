...
class Opengles1Display
	...
	fun native_blit(image: Opengles1Image, x, y: Float)  `{
	...
	fun native_blit_rotated(image: Opengles1Image, x, y, angle: Float) `{
		GLfloat texture_coord[4][2] =
		{
			{image->src_xo, image->src_yi},
			{image->src_xi, image->src_yi},
	...
	fun native_blit_stretched(image: I, ax, ay, bx, by, cx, cy, dx, dy: Float) `{
		GLfloat texture_coord[4][2] =
		{
			{image->src_xo, image->src_yi},
			{image->src_xi, image->src_yi},

...
class RectangleButton
	...
	redef type SELF: RectangleButton
end
...
class HorizontalMenu
	super RectangleMenu
	redef type SELF: HorizontalMenu
...
class TextRectangleButton
	...
	redef type SELF: TextRectangleButton
...
class TextInputControl
	...
	redef type SELF: TextInputControl
...
class PasswordInputControl
	...
	redef type SELF: PasswordInputControl
...
class NumberInputControl
	super TextInputControl
	redef type SELF: NumberInputControl
